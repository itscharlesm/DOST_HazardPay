                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="employee_no" class="form-control" id="employee_no" value="{{ $employee->employee_no }}" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name" value="{{ $employee->name }}" autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label for="designation">Designation:<span style="color: red; font-weight: bold;">*</span></label>
                                        <input type="text" name="designation" class="form-control" id="designation" value="{{ $employee->designation }}" autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        </div>
